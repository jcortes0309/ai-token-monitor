...
macOS와 Windows의 시스템 트레이에서 Claude Code의 토큰 사용량과 비용을 실시간으로 추적하는 앱입니다.
...
- **캐시 효율** — 캐시 히트율 도넛 차트
- **트레이 비용 표시** — 시스템 트레이에 오늘 비용 실시간 표시 (macOS: 메뉴바 타이틀, Windows: 툴팁)
...
- **Tray Cost**: 시스템 트레이에 오늘 비용 표시 on/off
