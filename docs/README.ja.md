...
macOS と Windows のシステムトレイで Claude Code のトークン使用量とコストをリアルタイムに追跡するアプリです。
...
| 今日の使用量、7日間チャート、週間/月間集計 | アクティビティグラフ、30日間トレンド、モデル別分析 | 他のユーザーと比較 |
...
- **トレイコスト表示** — システムトレイに今日のコストをリアルタイム表示（macOS: メニューバータイトル、Windows: ツールチップ）
...
1. アプリを起動すると、システムトレイ（macOS メニューバー / Windows タスクバー）にアイコンが表示されます
...
- **Tray Cost**：システムトレイに今日のコストを表示/非表示
